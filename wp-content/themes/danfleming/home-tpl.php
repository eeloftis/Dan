...
<?php
       ...
       <?php if ($wp_query->current_post % 2 == 0): ?>
         ...
         <div class="projectCard odd row">
           <div class="col-xs-10 col-xs-offset-1 col-lg-6 col-lg-offset-0 col-md-5 col-md-offset-0 col-sm-5 col-sm-offset-0"><img src="<?php
           echo get_field('home_image')['url'];
           ?>" ></div>
           <div class="col-xs-10 col-xs-offset-1 col-lg-6 col-lg-offset-0 col-md-7 col-md-offset-0 col-sm-7 col-sm-offset-0" style="background-image:url('<?php
